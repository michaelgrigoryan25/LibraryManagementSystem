...
public class ProfessorRegistrationDto {
    ...
    public ProfessorRegistrationDto(String firstName, String lastName, String username, String password) {
    ...
    public boolean equals(Object o) {
        ...
        ProfessorRegistrationDto that = (ProfessorRegistrationDto) o;
    ...
    public String toString() {
        return "ProfessorRegistrationDto{" +
                ", firstName='" + firstName + '\'' +
                ", lastName='" + lastName + '\'' +
                ", username='" + username + '\'' +
                ", password='" + password + '\'' +
